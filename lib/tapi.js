...
Object.extend(module.exports, {
  ...
  trends_follow:function(data, callback, context){
  	return this.api_dispatch(data).trends_follow(data, callback, context);
  },

  trends:function(data, callback, context){
  	return this.api_dispatch(data).trends(data, callback, context);
  }, 
  
  trends_destroy:function(data, callback, context){
  	return this.api_dispatch(data).trends_destroy(data, callback, context);
  },

  comments_to_me :function(data, callback, context){
  	return this.api_dispatch(data).comments_to_me(data, callback, context);
  }
});
